    ...
    return (
        <div className='flex  bg-opacity-100   bg-blue-950'>
            ...
            <div className='about p-8  '>
              ...
              <li  className='my-3'>Flipkart Stories</li>
            ...
            <div className='about p-8  '>
              ...
              <li  className='my-3'>Cleartip</li>
              <li  className='my-3'>shopsy</li>
            ...
            <div className='about p-8  '>
              ...
              <li  className='my-3'>Report Infringement</li>
            ...
            <div className='about p-8  '>
              ...
              <li  className='my-3'>Sitemap</li>
              <li  className='my-3'>Grivances Redressal</li>
              <li  className='my-3'>EPR Compilance</li>
              </div>
